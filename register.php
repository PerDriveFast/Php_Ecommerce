...
<head>
    ...
    <link rel="shortcut icon" href="dist_font/img/favicon.png" type="image/x-icon">
    ...
    <link rel="stylesheet" href="dist_font/css/vendor.css">
    <link rel="stylesheet" href="dist_font/css/spacing.css">
    <link rel="stylesheet" href="dist_font/css/style.css">
</head>
...
<body>
    <div class="body-wrapper">
                    ...
                    <div class="col-lg-3 d-lg-block d-none">
                        <div class="announcement-call-wrapper">
                            <div class="announcement-call">
                                <a class="announcement-text text-white" href="tel:+01912000000">Call: +01912000000</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-4">
                            <div class="header-logo">
                                <a href="index.html" class="logo-main">
                                    <img src="dist_font/img/logo.png" loading="lazy" alt="">
                                </a>
                            </div>
                        </div>
                    ...
                    <form action="" class="login-form common-form mx-auto" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <a href="login.html" class="btn-secondary mt-2 btn-signin">GO TO LOGIN PAGE</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="footer-bottom bg-5">
                <div class="container">
                    <div
                        ...
                        <p class="copyright footer-text">Copyright © John Doe. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
        ...
        <!-- all js -->
        <script src="dist_font/js/vendor.js"></script>
        <script src="dist_font/js/main.js"></script>
    </div>
</body>
